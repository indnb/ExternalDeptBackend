use crate::dto::request::hackathon_2025::university::{University, VecUniversity};
...
#[post("/hackathon_2025/university/create", data = "<data>")]
pub async fn create(
    db_pool: &DbState,
...
#[post("/hackathon_2025/university/create_by_vec", data = "<data>")]
pub async fn create_by_vec(
    ...
    let id = crate::diesel::utils::hackathon_2025::university::insert::new_by_vec(
        db_pool,
        data.into_inner().0,
    )?;
