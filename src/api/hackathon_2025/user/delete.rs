...
#[utoipa::path(
    delete,
    path = "/api/hackathon_2025/user/by_id/{user_id}",
...
#[delete("/hackathon_2025/user/by_id/<user_id>")]
pub async fn by_id(
    db_pool: &DbState,
    user_id: i32,
    ...
    let user_id = crate::diesel::utils::hackathon_2025::user::delete::by_id(db_pool, user_id)?;
    info!("Successfully deleted hackathon_user_2025 from hackathon 2024 with id {user_id}");
    Ok(())
}
