...
pub fn university(db_pool: &State<DbPool>, data: HackathonUniversity2024Insertable) -> Result<i32, ApiError> {
    ...
    diesel::insert_into(crate::diesel::schema::hackathon_university_2024::table)
        ...
        .map_err(|err| {
            log::error!("Error inserting hackathon 2024 university with id - {:?}", err);
